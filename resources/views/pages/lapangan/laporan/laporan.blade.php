	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="alert alert-info">
			  <p>Simpan laporan tiap akhir bulan dengan menggunakan tombol <strong>SIMPAN</strong></p>
			</div>
			</div>
			<div class="col-md-2">
				<form action="{{route('ml.laporan.save')}}">
				<input type="hidden" name="modal" value="{{$perubahanmodal['modalakhir']}}">
				<input type="hidden" name="kas" value="{{$aruskas['kasakhirperiode']}}">
				<input type="hidden" name="peralatan" value="{{$neraca['peralatan']-$neraca['akumulasi']}}">
				<input type="hidden" name="penyusutan" value="{{$neraca['akumulasi']}}">
				<input type="hidden" name="bulan" value="{{$month+1}}">
				<input type="hidden" name="tahun" value="{{$year}}">
				<button class="btn btn-lg btn-success" style="width: 100%;">SIMPAN</button>
				</form>
			</div>
			<div class="col-md-2">
				<a href="{{route('ml.laporan.cetak_keuangan')}}" class="btn btn-lg btn-primary" style="width: 100%;">Print</a>
			</div>
