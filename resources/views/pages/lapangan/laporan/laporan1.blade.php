...
<div class="laporan">
	...
	<br><br>
	<div>
	<form method="post" action="{{route('ml.laporan.cetak_keuangan1')}}" role="form">
		<input type="hidden" name="bulan" value="{{$month}}"></input>
		<input type="hidden" name="tahun" value="{{$year}}"></input>
		<input type="hidden" name="_token" value="{{csrf_token()}}"></input>
        <button type="submit" class="btn btn-flat btn-primary" style="width: 100%;">Print</button>
	</form>
	</div>
</div>
