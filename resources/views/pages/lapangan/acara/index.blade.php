        ...
        <div class="col-md-12">
          ...
          <div class="box-header">
              ...
              <div class="pull-right box-tools">
                <a href="{{ route('ml.acara.create') }}" class="btn btn-flat btn-primary"><i class="fa fa-plus"></i> Tambah</a>  
              </div>
              <!-- /. tools -->
          </div>
            <div class="box-body">
            <table class="table table-striped table-responsive">
                ...
                <tr>
                	...
                	<td>
                		<a href="{{route('ml.acara.read',[$acaras->id])}}" class="btn btn-flat bg-olive"><i class="fa fa-eye"></i></a>
                		<a href="{{route('ml.acara.update',[$acaras->id])}}" class="btn btn-flat btn-info"><i class="fa fa-pencil"></i></a>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{route('ml.acara.delete',[$acaras->id])}}" class="btn btn-flat btn-danger">Yes</a>
                            </div>
                          </div>
                        </div>
                      </div>                        
