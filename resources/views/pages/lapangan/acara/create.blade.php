      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form class="form form-horizontal" method="POST" action="{{route('ml.acara.store')}}" enctype="multipart/form-data">
              <!-- {{ csrf_field() }} -->
                <div class="form-group" hidden="true">
                   <label class="control-label col-md-3">User</label>
                   <div class="col-md-9">
                      <input type="text" name="idpeople" class="form-control" value="{{Auth::user()->id}}">
                   </div>
                </div>
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-9">
                      <input type="text" name="namakontak1" class="form-control" >
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Kontak 1</label>
                   <div class="col-md-9">
                      <input type="text" name="kontak1" class="form-control" >
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Nama Kontak 2</label>
                   <div class="col-md-9">
                      <input type="text" name="namakontak2" class="form-control" >
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Kontak 2</label>
                   <div class="col-md-9">
                      <input type="text" name="kontak2" class="form-control" >
                   </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-9">
                      <input type="text" name="hadiahutama" class="form-control" >
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Awal Pendaftaran</label>
                   <div class="col-md-9">
                      <input type="date" name="awaldaftar" class="form-control" >
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Akhir Pendaftaran</label>
                   <div class="col-md-9">
                      <input type="date" name="akhirdaftar" class="form-control" >
                   </div>
                </div>
                <div class="form-group">
