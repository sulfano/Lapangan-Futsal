      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form class="form form-horizontal" method="POST" action="{{route('ml.acara.save',[$acara->id])}}" enctype="multipart/form-data">
              <!-- {{ csrf_field() }} -->
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-9">
                      <input type="text" name="namaacara" class="form-control"  value="{{$acara->namaacara}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Pelaksana</label>
                   <div class="col-md-9">
                      <input type="text" name="pelaksana" class="form-control"  value="{{$acara->pelaksana}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Tanggal Mulai</label>
                   <div class="col-md-9">
                      <input type="date" name="tanggalmulai" class="form-control"  value="{{$acara->tanggalmulai}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Tanggal Akhir</label>
                   <div class="col-md-9">
                      <input type="date" name="tanggalakhir" class="form-control"  value="{{$acara->tanggalakhir}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Jam Mulai</label>
                   <div class="col-md-9">
                      <input type="time" name="jammulai" class="form-control"  value="{{$acara->jammulai}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Jam Akhir</label>
                   <div class="col-md-9">
                      <input type="time" name="jamakhir" class="form-control"  value="{{$acara->jamakhir}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Nama Kontak 1</label>
                   <div class="col-md-9">
                      <input type="text" name="namakontak1" class="form-control"  value="{{$acara->namakontak1}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Kontak 1</label>
                   <div class="col-md-9">
                      <input type="text" name="kontak1" class="form-control"  value="{{$acara->kontak1}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Nama Kontak 2</label>
                   <div class="col-md-9">
                      <input type="text" name="namakontak2" class="form-control"  value="{{$acara->namakontak2}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Kontak 2</label>
                   <div class="col-md-9">
                      <input type="text" name="kontak2" class="form-control"  value="{{$acara->kontak2}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Biaya</label>
                   <div class="col-md-9">
                      <input type="text" name="biaya" class="form-control"   value="{{$acara->biaya}}"></input>
                   </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-9">
                      <input type="text" name="totalhadiah" class="form-control"  value="{{$acara->totalhadiah}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Hadiah Utama</label>
                   <div class="col-md-9">
                      <input type="text" name="hadiahutama" class="form-control"  value="{{$acara->hadiahutama}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Awal Pendaftaran</label>
                   <div class="col-md-9">
                      <input type="date" name="awaldaftar" class="form-control"  value="{{$acara->awal_daftar}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Akhir Pendaftaran</label>
                   <div class="col-md-9">
                      <input type="date" name="akhirdaftar" class="form-control"  value="{{$acara->akhir_daftar}}"></input>
                   </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-md-3">Kuota</label>
                   <div class="col-md-9">
                      <input type="text" name="kuota" class="form-control"  value="{{$acara->kuota}}"></input>
                   </div>
                </div>
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-9">
                      <input type="text" name="tempat" class="form-control"  value="{{$acara->tempat}}"></input>
                   </div>
                </div>
                <div class="form-group">
