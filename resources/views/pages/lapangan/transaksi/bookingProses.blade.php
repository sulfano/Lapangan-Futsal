      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form class="form-horizontal" method="post" role="form" action="{{route('ml.booking.change',[$booking->id])}}">
                <div class="form-group">
                  <label class="control-label col-md-2">Total</label>
                  <div class="col-md-10">
                    <input type="text" name="total" id="total" class="form-control" value="{{$total}}" readonly="">
                    <input type="hidden" name="nama" class="form-control" value="{{$booking->pembooking}}" readonly="">
                  </div>
                </div>
                <div class="form-group">
