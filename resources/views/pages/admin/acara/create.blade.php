      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form class="form form-horizontal" method="POST" action="{{route('admin.acara.store')}}"  enctype="multipart/form-data">
              <!-- {{ csrf_field() }} -->
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-9">
                      <input type="text" name="biaya" class="form-control" required=""></input>
                   </div>
                </div>
                <div class="form-group">
