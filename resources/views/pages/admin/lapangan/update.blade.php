...
@foreach($lapangan as $lapangan)
  <div class="content-wrapper">
      ...
      <div class="row">
      <form class="form form-horizontal" method="POST" action="{{route('admin.lapangan.save',[$lapangan->kodelapangan])}}" enctype="multipart/form-data">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="  form-group">
                  ...
                  <div class="col-md-9">
                  <div class="col-md-6"><input type="radio" name="status" value="1">Aktif</div>
                  <div class="col-md-6"><input type="radio" name="status" value="2">Non-Aktif</div>
                ...
                <div class="form-group">
                  ...
                  <a href="{{route('admin.lapangan')}}" class="btn btn-flat btn-warning"><i class="fa fa-ban"></i></a>
                  </div>
                </div>                
            </div>
          </div>
