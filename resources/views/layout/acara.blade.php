...
<head>
  ...
  <title>Futsal | Member Acara</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="/memberacara">Beranda</a></li>
          </ul>
        </div>		
        <!-- Collect the nav links, forms, and other content for toggling -->
<!--         <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="{{ route('acara') }}">Acara <span class="sr-only">(current)</span></a></li>
          </ul>
        </div> -->
        <!-- /.navbar-collapse -->
        <!-- Navbar Right Menu -->
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="{{route('memberacara.akun',[Auth::user()->id])}}" class="btn btn-default btn-flat">Akun</a>
                  </div>
